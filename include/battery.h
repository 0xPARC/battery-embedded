...
#define PUB_ROOT_SIZE HASH_SIZE

#define PUB_COMMIT_SIZE HASH_SIZE

#define PUB_NONCE_SIZE HASH_SIZE

#define PUB_TOTAL_SIZE ((PUB_ROOT_SIZE + PUB_COMMIT_SIZE) + PUB_NONCE_SIZE)
